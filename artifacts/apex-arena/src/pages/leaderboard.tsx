...
export default function Leaderboard() {
  ...
  return (
    <PageWrapper className="container max-w-screen-xl px-4 py-16 mx-auto">
      <div className="max-w-4xl mx-auto space-y-12">
        <div className="text-center space-y-6">
          <motion.div 
            ...
            className="inline-flex items-center justify-center p-5 bg-gradient-to-br from-yellow-500/20 to-yellow-600/5 rounded-2xl mb-2 border border-yellow-500/30 shadow-[0_0_30px_rgba(234,179,8,0.2)]"
          >
          ...
          >
            <h1 className="text-5xl font-extrabold tracking-tight font-display mb-4 text-transparent bg-clip-text bg-gradient-to-b from-white to-white/60">Hall of Fame</h1>
        ...
        >
          <Card className="border-white/10 overflow-hidden bg-card/60 backdrop-blur-xl shadow-2xl relative">
            ...
            <CardHeader className="bg-secondary/30 border-b border-white/5 py-6 px-8">
              <CardTitle className="font-display text-2xl">Global Rankings</CardTitle>
              <CardDescription className="text-sm font-medium uppercase tracking-widest mt-1">Ranked by total solved problems</CardDescription>
            </CardHeader>
            <CardContent className="p-0">
              <Table>
                <TableHeader className="bg-black/20">
                  <TableRow className="hover:bg-transparent border-white/5">
                    <TableHead className="w-24 text-center font-mono text-xs uppercase tracking-widest text-muted-foreground h-12">Rank</TableHead>
                    ...
                    <TableHead className="text-right font-mono text-xs uppercase tracking-widest text-muted-foreground h-12 pr-8">Submissions</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {isLoading ? (
                          ...
                          <TableCell className="py-4">
                            <div className="flex items-center gap-4">
                              ...
                              <div className={cn(
                                ...
                                isTop3 ? "text-xl" : "text-lg text-foreground/90 group-hover:text-foreground",
                                i === 0 && "text-yellow-500",
                                i === 1 && "text-gray-300",
                                i === 2 && "text-amber-600"
                              )}>
